...
export default function CheckoutScreen() {
  ...
  const handlePayment = () => {
    ...
    setTimeout(() => {
      try {
        const strategy = resolveStrategy(15, selectedMethod);
        const checkout = new CheckoutContext(strategy);
        const success = strategy.pay(15);
        checkout.executePayment(15);
          ...
          <View style={styles.modalCard}>
            ...
            {status === 'credentials' && (
              <>
                ...
                <Text style={styles.modalSubtitle}>RM 15.00 • Campus Music Fest</Text>
            ...
            {status === 'success' && (
              <>
                ...
                <Text style={styles.modalSubtitle}>RM 15.00 paid via {methodLabel[selectedMethod]}</Text>
                <Text style={styles.modalSubtitle}>Your ticket for Campus Music Fest is being generated.</Text>
